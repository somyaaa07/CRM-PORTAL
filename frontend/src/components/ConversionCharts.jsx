  ...
  if (!data || data.length === 0) {
    return (
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <p className="text-center text-gray-400 py-8">Loading Chart......</p>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-5">
      ...
      <div className="flex items-center justify-between mb-5">
        <div>
          <h3 className="font-semibold text-gray-800">📈 Conversion Trends</h3>
          <p className="text-xs text-gray-500 mt-0.5">Last 14 days data</p>
        </div>
