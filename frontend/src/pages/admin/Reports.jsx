...
if (typeof document !== "undefined" && !document.getElementById("rpt-fonts")) {
  ...
  l.rel = "stylesheet";
  l.href =
    "https://fonts.googleapis.com/css2?family=Jost:wght@400;500;600;700&family=Manrope:wght@400;500;600;700;800&display=swap";
...
const rankStyle = (index) => {
  if (index === 0)
    return { ring: "2px solid #fcd34d", bg: "#fffbeb", color: "#92400e" };
  if (index === 1)
    return { ring: "2px solid #cbd5e1", bg: "#f8fafc", color: "#475569" };
  if (index === 2)
    return { ring: "2px solid #fdba74", bg: "#fff7ed", color: "#9a3412" };
  return { ring: "none", bg: PURPLE_LIGHT, color: PURPLE };
};

const rankBarStyle = (index) => {
  if (index === 0)
    return { background: "linear-gradient(90deg,#fbbf24,#f59e0b)" };
  if (index === 1)
    return { background: "linear-gradient(90deg,#cbd5e1,#94a3b8)" };
  if (index === 2)
    return { background: "linear-gradient(90deg,#fdba74,#fb923c)" };
  return null;
};
...
export default function Reports() {
  ...
  `}</style>
      <div
        style={{ ...manrope, minHeight: "100vh", background: BG, padding: 24 }}
      >
        {/* Header */}
                        ...
                        >
                          ...
                          >
                            {index < 3 ? (
                              ...
                              <span style={jost}>
                                {r.agentName.charAt(0).toUpperCase()}
                              </span>
                            )}
                            <span
                              style={{
                        ...
                        >
                          <div
                            style={{
                              ...
                              background:
                                r.conversionRate >= 70
                                  ? `linear-gradient(90deg,${PURPLE},#651fff)`
                                  : r.conversionRate >= 40
                      ...
                      {chartLoading ? (
                        ...
                        <div
                          style={{
                            ...
                            borderRadius: 20,
                            overflow: "hidden",
                            boxShadow: `0 4px 16px ${PURPLE}0d`,
                          }}
                        >
                          <div
                            style={{
